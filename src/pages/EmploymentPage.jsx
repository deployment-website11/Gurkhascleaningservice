...
const EmploymentPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const msg =
      ...
      *About Me:*%0A${formData.message}%0A%0A +
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <span className="animate-fade-up inline-block bg-[#f7fee7] text-[#166534] px-4 py-1.5 rounded-full text-sm font-bold mb-3 tracking-wide uppercase border border-[#bbf7d0]">
                Why Work With Us
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
              {benefits.map((b, i) => (
                <div key={i}
                  className="animate-fade-up group bg-[#fef9f0] hover:bg-[#166534] rounded-2xl p-7 text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                  style={{ animationDelay:`${i*80}ms` }}>
                  <div className="w-14 h-14 bg-[#dcfce7] group-hover:bg-[#84cc16] rounded-2xl flex items-center justify-center mx-auto mb-4 transition-colors duration-300">
                    <b.icon className="text-[#166534] group-hover:text-[#14532d] transition-colors duration-300" size={26} />
                  </div>
            ...
            {/* Perks */}
            <div className="animate-fade-up bg-[#fef9f0] rounded-2xl p-8 border border-[#dcfce7]">
              <h3 className="font-display text-xl font-bold text-gray-900 mb-6 text-center">More Reasons to Join</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {perks.map((perk) => (
                  <div key={perk} className="flex items-center gap-3">
                    <CheckCircle size={17} className="text-[#166534] flex-shrink-0" />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#fef9f0]">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-10">
              <span className="animate-fade-up inline-block bg-[#fef3c7] text-[#d97706] px-4 py-1.5 rounded-full text-sm font-bold mb-3 tracking-wide uppercase">
                Apply Now
              </span>
              <h2 className="animate-fade-up delay-100 font-display text-3xl font-extrabold text-gray-900">
                Submit Your Application
              </h2>
              <p className="animate-fade-up delay-200 text-gray-500 mt-2 text-sm">
